...
public class BlockPouchScreenHandler extends ScreenHandler {
    ...
    public BlockPouchScreenHandler(int syncId, PlayerInventory playerInv, PacketByteBuf buf) {
    ...
    private void loadPouchContents() {
        DefaultedList<ItemStack> contents = ItemWand.getPouchContents(wand);
    ...
    public ItemStack quickMove(PlayerEntity player, int index) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            if (slotStack == wand || ItemStack.canCombine(slotStack, wand)) {
    ...
    private static class PouchSlot extends Slot {
        ...
        public boolean canInsert(ItemStack stack) {
            return stack != wand && !ItemStack.canCombine(stack, wand);
        }
    }
}
