...
public class RenderBlockPreview {
    ...
    private static void drawBox(BufferBuilder buffer, MatrixStack matrices, Box box,
        ...
        buffer.vertex(matrices.peek().getPositionMatrix(), minX, minY, minZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), maxX, minY, minZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), minX, minY, minZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), minX, maxY, minZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), minX, minY, minZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), minX, minY, maxZ).color(red, green, blue, alpha);

        buffer.vertex(matrices.peek().getPositionMatrix(), maxX, maxY, maxZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), minX, maxY, maxZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), maxX, maxY, maxZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), maxX, minY, maxZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), maxX, maxY, maxZ).color(red, green, blue, alpha);
        buffer.vertex(matrices.peek().getPositionMatrix(), maxX, maxY, minZ).color(red, green, blue, alpha);
